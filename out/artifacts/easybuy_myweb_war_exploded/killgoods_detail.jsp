...
<script type="text/javascript">
    ...
    function timer() {
        ...
        var info =day + "天" +hour + "时" +minute + "分" + second + "秒";

       document.getElementById("timeSpan").innerHTML=info;
        if(intDiff==0){
    ...
    var nowInter =setInterval(timer,1000);
    //window.onload=timer;
</script>
        ...
        <div class="s_left">
            <div class="lim_time">
                ...
                <table border="0" style="width:100%; margin-bottom:50px;" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                        <td width="315">
                            <div class="lim_name">${killGood.title}</div>
                            <div class="lim_price">
                                <span class="ch_txt">￥5288</span>
                                <a href="/killgoods/${killGood.id}/addcar" class="ch_a">抢购</a>
                            </div>
                            <div class="lim_c">
                                <table border="0" style="width:100%; color:#888888;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr style="font-family:'Microsoft YaHei';">
                                        <td style="text-decoration:line-through;">￥${killGood.price}</td>
                                        <td>�${killGood.costPrice}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="lim_c">
